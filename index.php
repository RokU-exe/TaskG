...
<div data-vide-bg="video/color1">
	<div class="center-container">
		...
		<div class="main-content-agile">
			...
			<div class="sub-main-w3">	
				<form action="insert.php" method="post">
					<input placeholder="email" name="email" type="email" required="email">
		...
		<div class="main-content-agile">
			...
			<div class="sub-main-w3">	
				<form action="insert.php" method="post">
					<input placeholder="rollnumber" name="rollnumber" type="number" required="number">
					<span class="icon1"><i class="fa fa-user" aria-hidden="true"></i></span>
					<input  placeholder="name" name="name" type="text" required="name">
					<span class="icon2"><i class="fa fa-unlock" aria-hidden="true"></i></span>
					<div class="rem-w3">
						<span class="check-w3"><input type="checkbox" />Remember Me</span>
						<a href="#">Forgot Password?</a>
		...
		<!--footer-->
		<div class="footer">
			<p>&copy; 2017 Coloring Login Form. All rights reserved | Design by Le Xuan Loc</p>
		</div>
		<!--//footer-->
	</div>
</div>
